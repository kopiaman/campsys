...
//do login
 ...
 $matric_id=sprintf("%04s",$_POST['log_id']);
...
$LoginRS__query="SELECT StudentID,MatricNo,Passw,Name FROM student_info WHERE MatricNo LIKE '%$matric_id%' AND Passw='$log_pass' AND Access='Yes'";
