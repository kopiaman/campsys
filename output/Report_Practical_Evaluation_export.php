...
$layout->blocks["top"][] = "export";$page_layouts["Report_Practical_Evaluation_export"] = $layout;
...
$xt->display("Report_Practical_Evaluation_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Report_Practical_Evaluation.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Practical_Evaluation.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Practical_Evaluation.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Practical_Evaluation.csv");
