...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel(" Amount(RM)").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Invoice No").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Invoice Date").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Paid (RM)").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Outstanding(RM)").'</td>';	
