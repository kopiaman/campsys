...
{
	$fieldLabelsstudent_discipline["English"] = array();
	$fieldToolTipsstudent_discipline["English"] = array();
	$fieldLabelsstudent_discipline["English"]["ID"] = "ID";
	$fieldToolTipsstudent_discipline["English"]["ID"] = "";
	$fieldLabelsstudent_discipline["English"]["StudentID"] = "Student";
	$fieldToolTipsstudent_discipline["English"]["StudentID"] = "";
	$fieldLabelsstudent_discipline["English"]["Activity"] = "Activity";
	$fieldToolTipsstudent_discipline["English"]["Activity"] = "";
	$fieldLabelsstudent_discipline["English"]["Level"] = "Level";
	$fieldToolTipsstudent_discipline["English"]["Level"] = "";
	$fieldLabelsstudent_discipline["English"]["Date_Committed"] = "Date Committed";
	$fieldToolTipsstudent_discipline["English"]["Date_Committed"] = "";
	$fieldLabelsstudent_discipline["English"]["Action_Taken"] = "Action Taken";
	$fieldToolTipsstudent_discipline["English"]["Action_Taken"] = "";
	$fieldLabelsstudent_discipline["English"]["Comment"] = "Comment";
	$fieldToolTipsstudent_discipline["English"]["Comment"] = "";
	if (count($fieldToolTipsstudent_discipline["English"]))
...
$tdatastudent_discipline[".showSimpleSearchOptions"] = true;
