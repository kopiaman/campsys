...
{
	$fieldLabelsstudent_extracurricular["English"] = array();
	$fieldToolTipsstudent_extracurricular["English"] = array();
	$fieldLabelsstudent_extracurricular["English"]["ID"] = "ID";
	$fieldToolTipsstudent_extracurricular["English"]["ID"] = "";
	$fieldLabelsstudent_extracurricular["English"]["StudentID"] = "Student";
	$fieldToolTipsstudent_extracurricular["English"]["StudentID"] = "";
	$fieldLabelsstudent_extracurricular["English"]["Activity"] = "Activity";
	$fieldToolTipsstudent_extracurricular["English"]["Activity"] = "";
	$fieldLabelsstudent_extracurricular["English"]["Achievement"] = "Achievement";
	$fieldToolTipsstudent_extracurricular["English"]["Achievement"] = "";
	$fieldLabelsstudent_extracurricular["English"]["Start_Date"] = "Start Date";
	$fieldToolTipsstudent_extracurricular["English"]["Start_Date"] = "";
	$fieldLabelsstudent_extracurricular["English"]["End_Date"] = "End Date";
	$fieldToolTipsstudent_extracurricular["English"]["End_Date"] = "";
	$fieldLabelsstudent_extracurricular["English"]["Level"] = "Level";
	$fieldToolTipsstudent_extracurricular["English"]["Level"] = "";
	if (count($fieldToolTipsstudent_extracurricular["English"]))
...
$tdatastudent_extracurricular[".showSimpleSearchOptions"] = true;
