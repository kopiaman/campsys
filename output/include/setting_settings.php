...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelssetting["English"]["Class"] = "Category";
	...
	$fieldLabelssetting["English"]["Status"] = "Status";
	$fieldToolTipssetting["English"]["Status"] = "";
	$fieldLabelssetting["English"]["Sponsor"] = "Sponsor";
	$fieldToolTipssetting["English"]["Sponsor"] = "";
	$fieldLabelssetting["English"]["DipID"] = "Dip ID";
	$fieldToolTipssetting["English"]["DipID"] = "";
	$fieldLabelssetting["English"]["BatchID"] = "Batch ID";
	$fieldToolTipssetting["English"]["BatchID"] = "";
	$fieldLabelssetting["English"]["Exam_Status"] = "Exam Status";
	$fieldToolTipssetting["English"]["Exam_Status"] = "";
	$fieldLabelssetting["English"]["reason"] = "Reason";
	$fieldToolTipssetting["English"]["reason"] = "";
	$fieldLabelssetting["English"]["Exam_Remark"] = "Exam Remark";
	$fieldToolTipssetting["English"]["Exam_Remark"] = "";
	$fieldLabelssetting["English"]["exam_remark"] = "Exam Remark";
	$fieldToolTipssetting["English"]["exam_remark"] = "";
	$fieldLabelssetting["English"]["StateID"] = "State ID";
	$fieldToolTipssetting["English"]["StateID"] = "";
	$fieldLabelssetting["English"]["race"] = "Race";
	$fieldToolTipssetting["English"]["race"] = "";
	$fieldLabelssetting["English"]["qua_level"] = "Qua Level";
	$fieldToolTipssetting["English"]["qua_level"] = "";
	$fieldLabelssetting["English"]["HostelID"] = "Hostel ID";
	$fieldToolTipssetting["English"]["HostelID"] = "";
	$fieldLabelssetting["English"]["c1"] = "C1";
	$fieldToolTipssetting["English"]["c1"] = "";
	$fieldLabelssetting["English"]["c2"] = "C2";
	$fieldToolTipssetting["English"]["c2"] = "";
...
$tdatasetting[".showSimpleSearchOptions"] = true;
