...
{
	$fieldLabelsw_slider["English"] = array();
	$fieldToolTipsw_slider["English"] = array();
	$fieldLabelsw_slider["English"]["slid"] = "Slid";
	$fieldToolTipsw_slider["English"]["slid"] = "";
	$fieldLabelsw_slider["English"]["headline"] = "Headline";
	$fieldToolTipsw_slider["English"]["headline"] = "";
	$fieldLabelsw_slider["English"]["picture"] = "Picture";
	$fieldToolTipsw_slider["English"]["picture"] = "";
	$fieldLabelsw_slider["English"]["slink"] = "Link To News (Optional)";
	$fieldToolTipsw_slider["English"]["slink"] = "";
	$fieldLabelsw_slider["English"]["sstatus"] = "Status";
	$fieldToolTipsw_slider["English"]["sstatus"] = "";
	if (count($fieldToolTipsw_slider["English"]))
...
$tdataw_slider[".showSimpleSearchOptions"] = true;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "w_slider";
	$fdata["Label"] = "Link To News (Optional)"; 
	$fdata["FieldType"] = 200;
