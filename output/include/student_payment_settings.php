...
{
	$fieldLabelsstudent_payment["English"] = array();
	$fieldToolTipsstudent_payment["English"] = array();
	$fieldLabelsstudent_payment["English"]["amount"] = "Pay Amount";
	$fieldToolTipsstudent_payment["English"]["amount"] = "";
	$fieldLabelsstudent_payment["English"]["pay_date"] = "Pay Date";
	$fieldToolTipsstudent_payment["English"]["pay_date"] = "";
	$fieldLabelsstudent_payment["English"]["studentID"] = "Student";
	$fieldToolTipsstudent_payment["English"]["studentID"] = "";
	$fieldLabelsstudent_payment["English"]["terms"] = "Terms";
	$fieldToolTipsstudent_payment["English"]["terms"] = "";
	$fieldLabelsstudent_payment["English"]["ref_no"] = "Ref. No";
	$fieldToolTipsstudent_payment["English"]["ref_no"] = "";
	$fieldLabelsstudent_payment["English"]["pay_id"] = "Pay Id";
	$fieldToolTipsstudent_payment["English"]["pay_id"] = "";
	$fieldLabelsstudent_payment["English"]["student_bill_id"] = "Student Bill Id";
	$fieldToolTipsstudent_payment["English"]["student_bill_id"] = "";
	if (count($fieldToolTipsstudent_payment["English"]))
...
$tdatastudent_payment[".listAjax"] = false;
	...
	$tdatastudent_payment[".audit"] = true;
...
$tdatastudent_payment[".showSimpleSearchOptions"] = true;
...
$tdatastudent_payment[".googleLikeFields"][] = "student_bill_id";
$tdatastudent_payment[".googleLikeFields"][] = "amount";
$tdatastudent_payment[".googleLikeFields"][] = "pay_date";
$tdatastudent_payment[".googleLikeFields"][] = "studentID";
...
$tdatastudent_payment[".sqlHead"] = "SELECT pay_id,   student_bill_id,   amount,   pay_date,   studentID,   terms,   ref_no";
...
//	End Edit Formats
	...
	$tdatastudent_payment["student_bill_id"] = $fdata;
//	amount
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
...
//	End Edit Formats
	...
	$tdatastudent_payment["studentID"] = $fdata;
//	terms
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
...
$mIndex = 1-1;
	...
	$masterTablesData["student_payment"][$mIndex] = $masterParams;	
		$masterTablesData["student_payment"][$mIndex]["masterKeys"][]="student_bill_id";
		$masterTablesData["student_payment"][$mIndex]["masterKeys"][]="studentID";
		$masterTablesData["student_payment"][$mIndex]["detailKeys"][]="student_bill_id";
		$masterTablesData["student_payment"][$mIndex]["detailKeys"][]="studentID";
