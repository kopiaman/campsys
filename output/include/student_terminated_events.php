<?php 
class eventclass_student_terminated  extends eventsBase
{ 
	function eventclass_student_terminated()
	{
	// fill list of events
...
$strSQLExists2 = "select id from program_billing where programID='$programID' and  intake=YEAR($datejoin) and  branchID='$branchID'";
...
$sql_del3 = "DELETE FROM student_billing WHERE StudentID='$studentID'";
