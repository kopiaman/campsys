...
include("include/Report_Sponsor_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["Report_Sponsor_export"] = $layout;
...
$xt->display("Report_Sponsor_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Report_Sponsor.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Sponsor.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Sponsor.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Sponsor.csv");
