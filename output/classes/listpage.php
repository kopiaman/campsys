	...
	{	
		...
		foreach($this->selectedRecs as $keys) 
		{
			...
			if($this->lockingObj)
			{
				...
				$lockSQL = "select * from ".AddTableWrappers("campsys_mata4_locking")." where ".AddFieldWrappers("keys")."=".db_prepare_string($lockWhere)." and ".AddFieldWrappers("table")."=".db_prepare_string($this->origTName)." and ".AddFieldWrappers("action")."=1";
