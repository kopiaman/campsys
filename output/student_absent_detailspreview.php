...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["student_absent_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	reason - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("reason", $data, $keylink);
			$row["reason_value"] = $value;
		$rowinfo[] = $row;
		$data = $cipherer->DecryptFetchedArray($rs);
	}
...
$xt->load_template("student_absent_detailspreview.htm");
