...
$layout->blocks["top"][] = "search";$page_layouts["student_assesment_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "student_assesment_search.htm";
...
$params['shortTableName'] = 'student_assesment';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("taskno1"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno1")] = GetTableURL($pageObject->pSet->getLookupTable("taskno1"));
	
	$pageObject->fillFieldToolTips("taskno1");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno1");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno1";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno1_label","<label for=\"".GetInputElementId("taskno1", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno1_label", true);
	
	$xt->assign("taskno1_fieldblock", true);
	$xt->assignbyref("taskno1_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno1_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno1_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno1", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno1");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno1", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno1", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno2"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno2")] = GetTableURL($pageObject->pSet->getLookupTable("taskno2"));
	
	$pageObject->fillFieldToolTips("taskno2");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno2");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno2";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno2_label","<label for=\"".GetInputElementId("taskno2", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno2_label", true);
	
	$xt->assign("taskno2_fieldblock", true);
	$xt->assignbyref("taskno2_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno2_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno2_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno2", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno2");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno2", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno2", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno3"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno3")] = GetTableURL($pageObject->pSet->getLookupTable("taskno3"));
	
	$pageObject->fillFieldToolTips("taskno3");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno3");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno3";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno3_label","<label for=\"".GetInputElementId("taskno3", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno3_label", true);
	
	$xt->assign("taskno3_fieldblock", true);
	$xt->assignbyref("taskno3_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno3_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno3_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno3", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno3");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno3", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno3", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno4"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno4")] = GetTableURL($pageObject->pSet->getLookupTable("taskno4"));
	
	$pageObject->fillFieldToolTips("taskno4");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno4");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno4";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno4_label","<label for=\"".GetInputElementId("taskno4", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno4_label", true);
	
	$xt->assign("taskno4_fieldblock", true);
	$xt->assignbyref("taskno4_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno4_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno4_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno4", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno4");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno4", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno4", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno5"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno5")] = GetTableURL($pageObject->pSet->getLookupTable("taskno5"));
	
	$pageObject->fillFieldToolTips("taskno5");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno5");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno5";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno5_label","<label for=\"".GetInputElementId("taskno5", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno5_label", true);
	
	$xt->assign("taskno5_fieldblock", true);
	$xt->assignbyref("taskno5_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno5_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno5_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno5", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno5");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno5", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno5", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno6"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno6")] = GetTableURL($pageObject->pSet->getLookupTable("taskno6"));
	
	$pageObject->fillFieldToolTips("taskno6");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno6");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno6";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno6_label","<label for=\"".GetInputElementId("taskno6", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno6_label", true);
	
	$xt->assign("taskno6_fieldblock", true);
	$xt->assignbyref("taskno6_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno6_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno6_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno6", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno6");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno6", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno6", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("taskno7"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("taskno7")] = GetTableURL($pageObject->pSet->getLookupTable("taskno7"));
	
	$pageObject->fillFieldToolTips("taskno7");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("taskno7");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "taskno7";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("taskno7_label","<label for=\"".GetInputElementId("taskno7", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("taskno7_label", true);
	
	$xt->assign("taskno7_fieldblock", true);
	$xt->assignbyref("taskno7_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("taskno7_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("taskno7_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_taskno7", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("taskno7");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno7", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"taskno7", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
