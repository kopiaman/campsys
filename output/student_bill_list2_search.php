...
include("include/student_bill_list2_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["student_bill_list2_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "student_bill_list2_search.htm";
...
$params['shortTableName'] = 'student_bill_list2';
