...
$layout = new TLayout("chart5","MATA_StyleMATA_purple","MobileMATA_purple");
...
$layout->blocks["top"][] = "search";$page_layouts["Chart_Exam_Internal_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Chart_Exam_Internal",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Chart_Exam_Internal_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Chart_Exam_Internal_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Chart_Exam_Internal"))
