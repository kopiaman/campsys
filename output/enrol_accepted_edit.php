...
$layout->blocks["top"][] = "details";$page_layouts["enrol_accepted_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Personal_Particular1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Contact_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Parents_Guardian_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Medical_History1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Qualification_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_edit_Enclosures___Required_Documents_1"] = $layout;
...
$templatefile = "enrol_accepted_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: enrol_accepted_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='enrol_accepted_view.php?".$viewlink."'\"");
