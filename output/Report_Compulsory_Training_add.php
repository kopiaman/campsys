...
if($inlineadd == ADD_INLINE)
	$templatefile = "Report_Compulsory_Training_inline_add.htm";
else
	$templatefile = "Report_Compulsory_Training_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Report_Compulsory_Training_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Report_Compulsory_Training_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Report_Compulsory_Training_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Report_Compulsory_Training_".$pageObject->getPageType().".php");
