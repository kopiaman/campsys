...
$layout->blocks["top"][] = "details";$page_layouts["t_eva_assign_add"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_1__General_Aircraft_Maintenance1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_2__Mechanical_Fitting_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_3__Assembly___Disassembly_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_4__Wiring_and_Looming__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_5__Electrical_Power___Avionic_Systems__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_6_0_Sheet_Metal_Practices1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_add_7__Maintenance_Practices1"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "t_eva_assign_inline_add.htm";
else
	$templatefile = "t_eva_assign_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: t_eva_assign_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'t_eva_assign_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'t_eva_assign_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: t_eva_assign_".$pageObject->getPageType().".php");
