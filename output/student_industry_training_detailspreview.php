...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["student_industry_training_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	organization_name - 
		    ...
		    $value = $viewContainer->showDBValue("organization_name", $data, $keylink);
			$row["organization_name_value"] = $value;
	//	start_date - 
			$viewContainer->recId = $recordsCounter;
	...
	//	examStatus - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("examStatus", $data, $keylink);
			$row["examStatus_value"] = $value;
	//	unemployed - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("unemployed", $data, $keylink);
			$row["unemployed_value"] = $value;
	//	remarks - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("student_industry_training_detailspreview.htm");
