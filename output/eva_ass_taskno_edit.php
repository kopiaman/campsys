...
$templatefile = ($inlineedit == EDIT_INLINE) ? "eva_ass_taskno_inline_edit.htm" : "eva_ass_taskno_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: eva_ass_taskno_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: eva_ass_taskno_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='eva_ass_taskno_view.php?".$viewlink."'\"");
