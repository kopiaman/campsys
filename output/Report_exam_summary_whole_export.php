...
$layout->blocks["top"][] = "export";$page_layouts["Report_exam_summary_whole_export"] = $layout;
...
$xt->display("Report_exam_summary_whole_export.htm");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_exam_summary_whole.xml");
	...
	{
		$values = array();
			$values["Semester"] = $pageObject->showDBValue("Semester", $row);
			$values["Final_Exam"] = $pageObject->showDBValue("Final_Exam", $row);
			$values["Exam_Status"] = $pageObject->showDBValue("Exam_Status", $row);
			$values["Exam_Remark"] = $pageObject->showDBValue("Exam_Remark", $row);
			$values["BatchID"] = $pageObject->showDBValue("BatchID", $row);
			$values["Class"] = $pageObject->showDBValue("Class", $row);
			$values["Shortname"] = $pageObject->showDBValue("Shortname", $row);
			$values["shortcut_name"] = $pageObject->showDBValue("shortcut_name", $row);
			$values["Name"] = $pageObject->showDBValue("Name", $row);
			$values["course.CourseID"] = $pageObject->showDBValue("course.CourseID", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_exam_summary_whole.csv");
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"shortcut_name\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Name\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"course.CourseID\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"MatricNo\"";
	echo $outstr;
...
// write data rows
	...
	{
		$values = array();
			$values["Semester"] = $pageObject->getViewControl("Semester")->showDBValue($row, "");
			$values["Final_Exam"] = $pageObject->getViewControl("Final_Exam")->showDBValue($row, "");
			$values["Exam_Status"] = $pageObject->getViewControl("Exam_Status")->showDBValue($row, "");
			$values["Exam_Remark"] = $pageObject->getViewControl("Exam_Remark")->showDBValue($row, "");
			...
			$values["Shortname"] = $pageObject->getViewControl("Shortname")->showDBValue($row, "");
			$values["shortcut_name"] = $pageObject->getViewControl("shortcut_name")->showDBValue($row, "");
			$values["Name"] = $pageObject->getViewControl("Name")->showDBValue($row, "");
			$values["course.CourseID"] = $pageObject->getViewControl("course.CourseID")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Semester"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Final_Exam"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Exam_Status"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Exam_Remark"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Shortname"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["shortcut_name"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Name"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["course.CourseID"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mark(%)").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Module").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Course").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Course.Course ID").'</td>';	
		...
		if ($eventRes)
		{
			...
			echo "<tr>";
							...
							echo '<td>';
									...
									echo $values["Semester"];
			echo '</td>';
							echo '<td>';
			
									echo $values["Final_Exam"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
								...
								if($_REQUEST["type"]=="excel")
					echo PrepareForExcel($values["Exam_Remark"]);
				else
					echo $values["Exam_Remark"];//echo htmlspecialchars($values["Exam_Remark"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo '<td>';
								...
								if($_REQUEST["type"]=="excel")
					echo PrepareForExcel($values["Shortname"]);
				else
					echo $values["Shortname"];//echo htmlspecialchars($values["Shortname"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo '<td>';
								...
								if($_REQUEST["type"]=="excel")
					echo PrepareForExcel($values["shortcut_name"]);
				else
					echo $values["shortcut_name"];//echo htmlspecialchars($values["shortcut_name"]); commented for bug #6823
