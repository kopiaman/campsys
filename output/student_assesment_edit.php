...
$layout->blocks["top"][] = "details";$page_layouts["student_assesment_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_1__General_Aircraft_Maintenance1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_2__Mechanical_Fitting_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_3__Assembly___Disassembly_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_4__Wiring_and_Looming__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_5__Electrical_Power___Avionic_Systems__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_6_0_Sheet_Metal_Practices1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_assesment_edit_7__Maintenance_Practices1"] = $layout;
...
$templatefile = "student_assesment_edit.htm";
...
//	processing topic_1 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_1 = $pageObject->getControl("topic_1", $id);
		$control_topic_1->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_1 - end
//	processing topic_2 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_2 = $pageObject->getControl("topic_2", $id);
		$control_topic_2->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_2 - end
//	processing topic_3 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_3 = $pageObject->getControl("topic_3", $id);
		$control_topic_3->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_3 - end
//	processing topic_4 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_4 = $pageObject->getControl("topic_4", $id);
		$control_topic_4->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_4 - end
//	processing topic_5 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_5 = $pageObject->getControl("topic_5", $id);
		$control_topic_5->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_5 - end
//	processing topic_6 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_6 = $pageObject->getControl("topic_6", $id);
		$control_topic_6->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_6 - end
//	processing topic_7 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_topic_7 = $pageObject->getControl("topic_7", $id);
		$control_topic_7->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing topic_7 - end
//	processing taskno1 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno1 = $pageObject->getControl("taskno1", $id);
		$control_taskno1->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno1 - end
//	processing taskno2 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno2 = $pageObject->getControl("taskno2", $id);
		$control_taskno2->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno2 - end
//	processing taskno3 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno3 = $pageObject->getControl("taskno3", $id);
		$control_taskno3->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno3 - end
//	processing taskno4 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno4 = $pageObject->getControl("taskno4", $id);
		$control_taskno4->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno4 - end
//	processing taskno5 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno5 = $pageObject->getControl("taskno5", $id);
		$control_taskno5->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno5 - end
//	processing taskno6 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno6 = $pageObject->getControl("taskno6", $id);
		$control_taskno6->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing taskno6 - end
//	processing taskno7 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_taskno7 = $pageObject->getControl("taskno7", $id);
		$control_taskno7->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: student_assesment_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: student_assesment_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($readevalues)
{
	$data["topic_1"] = $evalues["topic_1"];
	$data["topic_2"] = $evalues["topic_2"];
	$data["topic_3"] = $evalues["topic_3"];
	$data["topic_4"] = $evalues["topic_4"];
	$data["topic_5"] = $evalues["topic_5"];
	$data["topic_6"] = $evalues["topic_6"];
	$data["topic_7"] = $evalues["topic_7"];
	$data["taskno1"] = $evalues["taskno1"];
	$data["taskno2"] = $evalues["taskno2"];
	$data["taskno3"] = $evalues["taskno3"];
	$data["taskno4"] = $evalues["taskno4"];
	$data["taskno5"] = $evalues["taskno5"];
	$data["taskno6"] = $evalues["taskno6"];
	$data["taskno7"] = $evalues["taskno7"];
}
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("topic_1_label","<label for=\"".GetInputElementId("topic_1", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_2_label","<label for=\"".GetInputElementId("topic_2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_3_label","<label for=\"".GetInputElementId("topic_3", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_4_label","<label for=\"".GetInputElementId("topic_4", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_5_label","<label for=\"".GetInputElementId("topic_5", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_6_label","<label for=\"".GetInputElementId("topic_6", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("topic_7_label","<label for=\"".GetInputElementId("topic_7", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno1_label","<label for=\"".GetInputElementId("taskno1", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno2_label","<label for=\"".GetInputElementId("taskno2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno3_label","<label for=\"".GetInputElementId("taskno3", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno4_label","<label for=\"".GetInputElementId("taskno4", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno5_label","<label for=\"".GetInputElementId("taskno5", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno6_label","<label for=\"".GetInputElementId("taskno6", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("taskno7_label","<label for=\"".GetInputElementId("taskno7", $id, PAGE_EDIT)."\">","</label>");
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='student_assesment_view.php?".$viewlink."'\"");
