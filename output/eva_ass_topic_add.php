...
if($inlineadd == ADD_INLINE)
	$templatefile = "eva_ass_topic_inline_add.htm";
else
	$templatefile = "eva_ass_topic_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: eva_ass_topic_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'eva_ass_topic_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'eva_ass_topic_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: eva_ass_topic_".$pageObject->getPageType().".php");
