...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["Report_Student_Course_detailspreview"] = $layout;
...
if($mastertable == "Report_Student_Course_List")
{
	$where = "";
...
$xt->load_template("Report_Student_Course_detailspreview.htm");
