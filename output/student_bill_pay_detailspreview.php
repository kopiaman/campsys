...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["student_bill_pay_detailspreview"] = $layout;
...
if($mastertable == "student_billing_item")
{
	$where = "";
		$where .= GetFullFieldName("student_bill_id", $strTableName, false)."=".make_db_value("student_bill_id",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->load_template("student_bill_pay_detailspreview.htm");
