...
$layout->blocks["top"][] = "export";$page_layouts["enrol_accepted_export"] = $layout;
...
$xt->display("enrol_accepted_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=enrol_accepted.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=enrol_accepted.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=enrol_accepted.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=enrol_accepted.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Date Applied/Key In").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Telephone 2").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Telephone 1").'</td>';	
	...
	{
		echo "<td>"."Program"."</td>";
		echo "<td>"."Date Applied/Key In"."</td>";
		echo "<td>"."Status"."</td>";
		echo "<td>"."Name"."</td>";
		echo "<td>"."IC NO"."</td>";
		echo "<td>"."Passport"."</td>";
		...
		echo "<td>"."State"."</td>";
		echo "<td>"."Country"."</td>";
		echo "<td>"."Telephone 2"."</td>";
		echo "<td>"."Telephone 1"."</td>";
		echo "<td>"."Email"."</td>";
		echo "<td>"."#1 Name"."</td>";
		echo "<td>"."Tel"."</td>";
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo $values["q1_g"];//echo htmlspecialchars($values["q1_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["q2_g"];//echo htmlspecialchars($values["q2_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["q3_g"];//echo htmlspecialchars($values["q3_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["q4_g"];//echo htmlspecialchars($values["q4_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g5_g"];//echo htmlspecialchars($values["g5_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g6_g"];//echo htmlspecialchars($values["g6_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g7_g"];//echo htmlspecialchars($values["g7_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g8_g"];//echo htmlspecialchars($values["g8_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g9_g"];//echo htmlspecialchars($values["g9_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g10_g"];//echo htmlspecialchars($values["g10_g"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["g11_g"];//echo htmlspecialchars($values["g11_g"]); commented for bug #6823
