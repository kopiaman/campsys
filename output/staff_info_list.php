...
include_once("include/staff_compulsory_training_settings.php");
include_once("include/staff_employement_history_settings.php");
include_once("include/staff_discipline_settings.php");
include_once("include/staff_qualification_settings.php");
include_once("include/staff_internal_history_settings.php");
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "StaffNo";
					}
