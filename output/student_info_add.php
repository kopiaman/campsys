...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_info_add_Family_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_info_add_Qualification1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_info_add_Medical1"] = $layout;
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'student_info_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'student_info_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if(@$_POST["a"]=="added" && ($inlineadd == ADD_INLINE || $inlineadd == ADD_MASTER || $inlineadd==ADD_POPUP)) 
{
	...
	$showDetailKeys["student_extracurricular"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_course"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_qualification"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_discipline"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_hostel"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_school"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["student_industry_training"]["masterkey1"] = $data["StudentID"];	
	$showDetailKeys["LIST-Student Billing"]["masterkey1"] = $data["StudentID"];	
