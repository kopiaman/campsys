...
$layout->blocks["top"][] = "details";$page_layouts["Marking_Student_list_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Personal1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Family_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Next_Of_Kin1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Campus_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Qualification1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Marking_Student_list_edit_Medical1"] = $layout;
...
$templatefile = "Marking_Student_list_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Marking_Student_list_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: Marking_Student_list_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Marking_Student_list_view.php?".$viewlink."'\"");
