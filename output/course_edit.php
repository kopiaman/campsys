...
//	processing color - begin
	$condition = $inlineedit==EDIT_INLINE;//($inlineedit) inline mode

	if($condition)
	{
		$control_color = $pageObject->getControl("color", $id);
		$control_color->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing color - end
	...
	//	processing Shortname - end
			//	processing color - begin
				...
				if($condition)
				{
					$control_color->afterSuccessfulSave();
				}
	//	processing color - end
