...
function ExportToXML($cipherer)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["father"] = $pageObject->showDBValue("father", $row);
			$values["father_tel"] = $pageObject->showDBValue("father_tel", $row);
			$values["mother"] = $pageObject->showDBValue("mother", $row);
			$values["mother_tel"] = $pageObject->showDBValue("mother_tel", $row);
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["father"] = $pageObject->getViewControl("father")->showDBValue($row, "");
			$values["father_tel"] = $pageObject->getViewControl("father_tel")->showDBValue($row, "");
			$values["mother"] = $pageObject->getViewControl("mother")->showDBValue($row, "");
			$values["mother_tel"] = $pageObject->getViewControl("mother_tel")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["father"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["father_tel"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["mother"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["mother_tel"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Father").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Father Tel").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mother").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mother Tel").'</td>';	
	...
	else
	{
		...
		echo "<td>"."Class"."</td>";
		echo "<td>"."Father"."</td>";
		echo "<td>"."Father Tel"."</td>";
		echo "<td>"."Mother"."</td>";
		echo "<td>"."Mother Tel"."</td>";
		echo "<td>"."Address"."</td>";
	}
	echo "</tr>";
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["father"]);
					else
						echo $values["father"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["father_tel"]);
					else
						echo $values["father_tel"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["mother"]);
					else
						echo $values["mother"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["mother_tel"]);
					else
						echo $values["mother_tel"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
