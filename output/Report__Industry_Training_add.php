...
$layout->blocks["top"][] = "details";$page_layouts["Report__Industry_Training_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "Report__Industry_Training_inline_add.htm";
else
	$templatefile = "Report__Industry_Training_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Report__Industry_Training_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Report__Industry_Training_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Report__Industry_Training_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Report__Industry_Training_".$pageObject->getPageType().".php");
...
if($readavalues)
{
	...
	$defvalues["organization_name"]=@$avalues["organization_name"];
	$defvalues["start_date"]=@$avalues["start_date"];
	$defvalues["end_date"]=@$avalues["end_date"];
	$defvalues["examStatus"]=@$avalues["examStatus"];
	$defvalues["duration"]=@$avalues["duration"];
	$defvalues["unemployed"]=@$avalues["unemployed"];
	$defvalues["remarks"]=@$avalues["remarks"];
}
...
if($inlineadd!=ADD_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("organization_name_label","<label for=\"".GetInputElementId("organization_name", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("examStatus_label","<label for=\"".GetInputElementId("examStatus", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("duration_label","<label for=\"".GetInputElementId("duration", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("unemployed_label","<label for=\"".GetInputElementId("unemployed", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("remarks_label","<label for=\"".GetInputElementId("remarks", $id, PAGE_ADD)."\">","</label>");
...
//	remarks
	...
	{	
		...
		$showRawValues["Program_Name"] = substr($data["Program_Name"],0,100);
