...
$layout->blocks["top"][] = "details";$page_layouts["enrol_reject_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Personal_Particular1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Contact_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Parents_Guardian_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Medical_History1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Qualification_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_edit_Enclosures___Required_Documents_1"] = $layout;
...
$templatefile = "enrol_reject_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: enrol_reject_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='enrol_reject_view.php?".$viewlink."'\"");
