...
$layout->blocks["top"][] = "export";$page_layouts["student_attendance_export"] = $layout;
...
$xt->display("student_attendance_export.htm");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=student_attendance.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=student_attendance.xml");
