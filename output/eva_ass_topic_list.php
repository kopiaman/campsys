...
include_once("include/eva_ass_taskno_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["eva_ass_topic_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "main_topic";
		}
