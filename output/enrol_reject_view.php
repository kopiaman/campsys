...
include("include/enrol_reject_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["enrol_reject_view"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Personal_Particular1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Contact_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Parents_Guardian_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Medical_History1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Qualification_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_reject_view_Enclosures___Required_Documents_1"] = $layout;
...
if (!sizeof($data)) {
	header("Location: enrol_reject_list.php?a=return");
	exit();
}
...
$arr = array();
$arr['fName'] = "f1_job";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("f1_job");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "f2_name";
...
$arr = array();
$arr['fName'] = "f2_job";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("f2_job");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "blood";
...
$arr = array();
$arr['fName'] = "at_ic";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_ic");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_coco";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_coco");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_dob";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_dob");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_fama";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_fama");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_spm";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_spm");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_famaic";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_famaic");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_slc";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_slc");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_trans";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("at_trans");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "at_photo";
...
//f1_job - 
	...
	if($mainTableOwnerID=="f1_job")
		$ownerIdValue=$value;
	$xt->assign("f1_job_value",$value);
...
//f2_job - 
	...
	if($mainTableOwnerID=="f2_job")
		$ownerIdValue=$value;
	$xt->assign("f2_job_value",$value);
...
//at_ic - Document Download
	...
	if($mainTableOwnerID=="at_ic")
		$ownerIdValue=$value;
	$xt->assign("at_ic_value",$value);
...
//at_coco - Document Download
	...
	if($mainTableOwnerID=="at_coco")
		$ownerIdValue=$value;
	$xt->assign("at_coco_value",$value);
...
//at_dob - Document Download
	...
	if($mainTableOwnerID=="at_dob")
		$ownerIdValue=$value;
	$xt->assign("at_dob_value",$value);
...
//at_fama - Document Download
	...
	if($mainTableOwnerID=="at_fama")
		$ownerIdValue=$value;
	$xt->assign("at_fama_value",$value);
...
//at_spm - Document Download
	...
	if($mainTableOwnerID=="at_spm")
		$ownerIdValue=$value;
	$xt->assign("at_spm_value",$value);
...
//at_famaic - Document Download
	...
	if($mainTableOwnerID=="at_famaic")
		$ownerIdValue=$value;
	$xt->assign("at_famaic_value",$value);
...
//at_slc - Document Download
	...
	if($mainTableOwnerID=="at_slc")
		$ownerIdValue=$value;
	$xt->assign("at_slc_value",$value);
...
//at_trans - Document Download
	...
	if($mainTableOwnerID=="at_trans")
		$ownerIdValue=$value;
	$xt->assign("at_trans_value",$value);
...
if($pageObject->isShowDetailTables && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "enrol_reject";
		$options['firstTime'] = 1;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='enrol_reject_edit.php?".$editlink."'\"");
