...
$layout = new TLayout("report5","MATA_StyleMATA_purple","MobileMATA_purple");
...
$layout->blocks["top"][] = "search";$page_layouts["Report_exam_summary_whole_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Report_exam_summary_whole_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Report_exam_summary_whole";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Report_exam_summary_whole_search.php';return false;\"");
