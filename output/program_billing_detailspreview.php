...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["program_billing_detailspreview"] = $layout;
...
if($mastertable == "Program_Batch_Bill")
{
	$where = "";
...
$xt->load_template("program_billing_detailspreview.htm");
