...
include("include/Report_Exam_Summary_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["Report_Exam_Summary_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "Report_Exam_Summary_search.htm";
...
$params['shortTableName'] = 'Report_Exam_Summary';
