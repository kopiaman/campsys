...
$layout->blocks["top"][] = "details";$page_layouts["timetable_attendance_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["timetable_attendance_edit_Datetime1"] = $layout;
...
$templatefile = "timetable_attendance_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: timetable_attendance_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: timetable_attendance_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='timetable_attendance_view.php?".$viewlink."'\"");
