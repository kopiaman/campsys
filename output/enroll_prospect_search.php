...
$layout->blocks["top"][] = "search";$page_layouts["enroll_prospect_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "enroll_prospect_search.htm";
...
$params['shortTableName'] = 'enroll_prospect';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("finance"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("finance")] = GetTableURL($pageObject->pSet->getLookupTable("finance"));
	
	$pageObject->fillFieldToolTips("finance");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("finance");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "finance";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("finance_label","<label for=\"".GetInputElementId("finance", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("finance_label", true);
	
	$xt->assign("finance_fieldblock", true);
	$xt->assignbyref("finance_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("finance_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("finance_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_finance", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("finance");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"finance", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"finance", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("qua_place"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("qua_place")] = GetTableURL($pageObject->pSet->getLookupTable("qua_place"));
	
	$pageObject->fillFieldToolTips("qua_place");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("qua_place");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "qua_place";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("qua_place_label","<label for=\"".GetInputElementId("qua_place", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("qua_place_label", true);
	
	$xt->assign("qua_place_fieldblock", true);
	$xt->assignbyref("qua_place_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("qua_place_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("qua_place_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_qua_place", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("qua_place");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"qua_place", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"qua_place", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("qua_result"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("qua_result")] = GetTableURL($pageObject->pSet->getLookupTable("qua_result"));
	
	$pageObject->fillFieldToolTips("qua_result");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("qua_result");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "qua_result";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("qua_result_label","<label for=\"".GetInputElementId("qua_result", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("qua_result_label", true);
	
	$xt->assign("qua_result_fieldblock", true);
	$xt->assignbyref("qua_result_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("qua_result_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("qua_result_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_qua_result", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("qua_result");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"qua_result", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"qua_result", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
