...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["student_evaluation_detailspreview"] = $layout;
...
if($mastertable == "Report_Practical_Evaluation")
{
	$where = "";
...
$xt->load_template("student_evaluation_detailspreview.htm");
