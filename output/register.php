...
$layout = new TLayout("register","MATA_StyleMATA_purple","MobileMATA_purple");
...
$layout = new TLayout("register_success","MATA_StyleMATA_purple","MobileMATA_purple");
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
...
//	send letter to admin
		...
		$message.= $strLabel.": ".$values["umail"]."\r\n";
		$sentMailResults = runner_mail(array('to' => "raizul@mataaviation.com", 'subject' => "Notification on registering", 'body' => $message));
