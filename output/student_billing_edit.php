...
$templatefile = ($inlineedit == EDIT_INLINE) ? "student_billing_inline_edit.htm" : "student_billing_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: student_billing_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: student_billing_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
//	detail tables
	$showDetailKeys["student_payment"]["masterkey1"] = $data["student_bill_id"];		
	$showDetailKeys["student_payment"]["masterkey2"] = $data["studentID"];		
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='student_billing_view.php?".$viewlink."'\"");
