...
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Personal_Particular1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Contact_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Parents_Guardian_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Medical_History1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Qualification_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enroll_add_Enclosures___Required_Documents_1"] = $layout;
...
//	processing f_job - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_f_job = $pageObject->getControl("f_job", $id);
		$control_f_job->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
...
//	processing m_job - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_m_job = $pageObject->getControl("m_job", $id);
		$control_m_job->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
...
//	processing at_ic - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_ic = $pageObject->getControl("at_ic", $id);
		$control_at_ic->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_ic - end
//	processing at_coco - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_coco = $pageObject->getControl("at_coco", $id);
		$control_at_coco->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_coco - end
//	processing at_dob - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_dob = $pageObject->getControl("at_dob", $id);
		$control_at_dob->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_dob - end
//	processing at_fama - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_fama = $pageObject->getControl("at_fama", $id);
		$control_at_fama->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_fama - end
//	processing at_spm - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_spm = $pageObject->getControl("at_spm", $id);
		$control_at_spm->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_spm - end
//	processing at_famaic - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_famaic = $pageObject->getControl("at_famaic", $id);
		$control_at_famaic->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_famaic - end
//	processing at_slc - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_slc = $pageObject->getControl("at_slc", $id);
		$control_at_slc->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing at_slc - end
//	processing at_trans - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd!=ADD_INLINE;
	if($inlineAddOption)
	{
		$control_at_trans = $pageObject->getControl("at_trans", $id);
		$control_at_trans->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'enroll_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'enroll_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
else
{
	...
	$defvalues["MobileTelephone"] = 60;
	$defvalues["HomeTelephone"] = 60;
...
if($inlineadd!=ADD_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("at_ic_label","<label for=\"".GetInputElementId("at_ic", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_dob_label","<label for=\"".GetInputElementId("at_dob", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_spm_label","<label for=\"".GetInputElementId("at_spm", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_slc_label","<label for=\"".GetInputElementId("at_slc", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_coco_label","<label for=\"".GetInputElementId("at_coco", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_fama_label","<label for=\"".GetInputElementId("at_fama", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_famaic_label","<label for=\"".GetInputElementId("at_famaic", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("at_trans_label","<label for=\"".GetInputElementId("at_trans", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("f_job_label","<label for=\"".GetInputElementId("f_job", $id, PAGE_ADD)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("m_job_label","<label for=\"".GetInputElementId("m_job", $id, PAGE_ADD)."\">","</label>");
