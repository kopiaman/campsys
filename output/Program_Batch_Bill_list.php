...
include("include/Program_Batch_Bill_variables.php");
include_once("include/program_billing_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["Program_Batch_Bill_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "DipID";
	}
