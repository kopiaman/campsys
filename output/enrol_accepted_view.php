...
include("include/enrol_accepted_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["enrol_accepted_view"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Personal_Particular1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Contact_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Parents_Guardian_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Medical_History1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Qualification_Information1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["enrol_accepted_view_Enclosures___Required_Documents_1"] = $layout;
...
if (!sizeof($data)) {
	header("Location: enrol_accepted_list.php?a=return");
	exit();
}
...
if($pageObject->isShowDetailTables && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "enrol_accepted";
		$options['firstTime'] = 1;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='enrol_accepted_edit.php?".$editlink."'\"");
