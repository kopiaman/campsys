...
include("include/student_compulsory_training_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["student_compulsory_training_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "student_compulsory_training_search.htm";
...
$params['shortTableName'] = 'student_compulsory_training';
