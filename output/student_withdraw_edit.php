...
$layout->blocks["top"][] = "details";$page_layouts["student_withdraw_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["student_withdraw_edit_Personal1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_withdraw_edit_Family_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_withdraw_edit_Next_Of_Kin1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_withdraw_edit_Campus_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_withdraw_edit_Medical1"] = $layout;
...
$templatefile = "student_withdraw_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: student_withdraw_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: student_withdraw_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='student_withdraw_view.php?".$viewlink."'\"");
