...
$templatefile = ($inlineedit == EDIT_INLINE) ? "setting_bill_item_inline_edit.htm" : "setting_bill_item_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: setting_bill_item_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: setting_bill_item_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='setting_bill_item_view.php?".$viewlink."'\"");
