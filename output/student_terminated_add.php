...
$layout->blocks["top"][] = "details";$page_layouts["student_terminated_add"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["student_terminated_add_Personal1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_terminated_add_Family_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_terminated_add_Next_Of_Kin1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_terminated_add_Campus_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["student_terminated_add_Medical1"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "student_terminated_inline_add.htm";
else
	$templatefile = "student_terminated_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: student_terminated_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'student_terminated_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'student_terminated_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: student_terminated_".$pageObject->getPageType().".php");
