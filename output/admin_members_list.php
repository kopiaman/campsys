...
$gsqlWhereExpr="";
$gsqlTail="";
// $gstrSQL = "SELECT id,   icNo,   password,   `role`,   username,   fullname,   department,   umail  FROM `user` ";
...
$layout = new TLayout("ug_members2","MATA_StyleMATA_purple","MobileMATA_purple");
