...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["staff_info_edit_Contact1"] = $layout;
...
//	processing Home_Tel - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_Home_Tel = $pageObject->getControl("Home_Tel", $id);
		$control_Home_Tel->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing Employee_Type - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_Employee_Type = $pageObject->getControl("Employee_Type", $id);
		$control_Employee_Type->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing bank2 - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_bank2 = $pageObject->getControl("bank2", $id);
		$control_bank2->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing epf - end
//	processing socso - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_socso = $pageObject->getControl("socso", $id);
		$control_socso->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing socso - end
//	processing lhdn - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_lhdn = $pageObject->getControl("lhdn", $id);
		$control_lhdn->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);

		}
//	processing lhdn - end
//	processing confirmation_date - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode

	if($condition)
	{
		$control_confirmation_date = $pageObject->getControl("confirmation_date", $id);
		$control_confirmation_date->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
if($readevalues)
{
	...
	$data["Home_Tel"] = $evalues["Home_Tel"];
	...
	$data["Employee_Type"] = $evalues["Employee_Type"];
	...
	$data["bank2"] = $evalues["bank2"];
	$data["epf"] = $evalues["epf"];
	$data["socso"] = $evalues["socso"];
	$data["lhdn"] = $evalues["lhdn"];
	$data["confirmation_date"] = $evalues["confirmation_date"];
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("Home_Tel_label","<label for=\"".GetInputElementId("Home_Tel", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("Employee_Type_label","<label for=\"".GetInputElementId("Employee_Type", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("bank2_label","<label for=\"".GetInputElementId("bank2", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("socso_label","<label for=\"".GetInputElementId("socso", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("lhdn_label","<label for=\"".GetInputElementId("lhdn", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("confirmation_date_label","<label for=\"".GetInputElementId("confirmation_date", $id, PAGE_EDIT)."\">","</label>");
	...
	if($inlineedit == EDIT_INLINE)
	{
		...
		$controls["controls"]['mode'] = "inline_edit";
			...
			$controls["controls"]['mode'] = "edit";
							...
							if($pageObject->pSet->isUseRTE("Race") && $fName == "Race")
	{
		$_SESSION[$strTableName."_"."Race"."_rte"] = "Malay";
