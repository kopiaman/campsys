...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Marking_Batch_inline_edit.htm" : "Marking_Batch_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Marking_Batch_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: Marking_Batch_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
//	cgpa - Custom
	$value = $pageObject->showDBValue("cgpa", $data, $keylink);
	$showValues["cgpa"] = $value;
	$showFields[] = "cgpa";
		$showRawValues["cgpa"] = substr($data["cgpa"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "Marking_Batch";
		$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Marking_Batch_view.php?".$viewlink."'\"");
