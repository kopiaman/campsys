...
$layout = new TLayout("report5","BoldOrange","MobileOrange");
...
$layout->blocks["top"][] = "search";$page_layouts["Report_attend_detail_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Report_attend_detail_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Report_attend_detail";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Report_attend_detail_search.php';return false;\"");
