...
$layout->blocks["top"][] = "details";$page_layouts["t_eva_assign_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_1__General_Aircraft_Maintenance1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_2__Mechanical_Fitting_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_3__Assembly___Disassembly_Practices__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_4__Wiring_and_Looming__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_5__Electrical_Power___Avionic_Systems__Common_1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_6_0_Sheet_Metal_Practices1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["t_eva_assign_edit_7__Maintenance_Practices1"] = $layout;
...
$templatefile = "t_eva_assign_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: t_eva_assign_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: t_eva_assign_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "t_eva_assign";
		$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='t_eva_assign_view.php?".$viewlink."'\"");
