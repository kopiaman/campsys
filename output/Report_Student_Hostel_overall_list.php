...
include("include/Report_Student_Hostel_overall_variables.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["Report_Student_Hostel_overall_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "HostelID";
		}
